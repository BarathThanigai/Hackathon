...
export function Field({
  ...
  return (
    <label className="block">
      ...
      <div
        className={`flex items-center rounded-lg border bg-ink/60 px-3 transition-all duration-200 ${
          focused
            ? "border-teal shadow-[0_0_0_3px_rgba(45,212,191,0.12)]"
            : "border-line-2"
        }`}
      >
        <input
...
function EyeOff() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M6.2 3.3A6.6 6.6 0 0 1 8 3.5c4.5 0 7 4.5 7 4.5a12 12 0 0 1-2 2.5M3.5 4.6A12 12 0 0 0 1 8s2.5 4.5 7 4.5a6.6 6.6 0 0 0 2.3-.4"
        stroke="currentColor"
        strokeWidth="1.2"
      />
...
export function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16">
      <path
        d="M15.7 8.2c0-.5 0-1-.1-1.5H8v2.9h4.3a3.7 3.7 0 0 1-1.6 2.4v2h2.6c1.5-1.4 2.4-3.5 2.4-5.8Z"
        fill="#4285F4"
      />
      <path
        d="M8 16c2.2 0 4-.7 5.3-2l-2.6-2c-.7.5-1.6.8-2.7.8-2 0-3.8-1.4-4.4-3.3H.9v2C2.3 14.3 5 16 8 16Z"
        fill="#34A853"
      />
      <path
        d="M3.6 9.5A4.8 4.8 0 0 1 3.3 8c0-.5.1-1 .3-1.5v-2H.9A8 8 0 0 0 0 8c0 1.3.3 2.5.9 3.5l2.7-2Z"
        fill="#FBBC05"
      />
      <path
        d="M8 3.2c1.2 0 2.2.4 3 1.2l2.3-2.3A8 8 0 0 0 .9 4.5l2.7 2C4.2 4.6 6 3.2 8 3.2Z"
        fill="#EA4335"
      />
    </svg>
  )
...
export function GithubIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
      <path d="M8 0a8 8 0 0 0-2.5 15.6c.4 0 .5-.2.5-.4v-1.4c-2 .5-2.5-.9-2.5-.9-.3-.9-.8-1.1-.8-1.1-.7-.4 0-.4 0-.4.7 0 1.1.8 1.1.8.7 1.1 1.7.8 2.1.6 0-.5.3-.8.5-1-1.6-.2-3.3-.8-3.3-3.6 0-.8.3-1.5.8-2 0-.2-.4-1 .1-2 0 0 .6-.2 2 .8a7 7 0 0 1 3.6 0c1.4-1 2-.8 2-.8.5 1 .1 1.8 0 2 .5.5.8 1.2.8 2 0 2.8-1.7 3.4-3.3 3.6.3.2.5.7.5 1.4v2c0 .2.1.4.5.4A8 8 0 0 0 8 0Z" />
    </svg>
  )
}
